...
**代填狀態（2026-09-26）**：提交 ID `1152921505701981084`。套件換成 `AiUsageMeter-0.1.1.0-x64.msix`（WACK PASS 16:02；舊的 0.1.0 被標成移除，⚠️ 要在套件頁**再按一次 Save** 才真的移除）；中英文清單的說明、12 條功能、此版本新增功能、第 3 張截圖已換；其他測試資訊（產品層級）已補最後一段。runFullTrust 欄位仍沒出現。✅ 業主 2026-09-26 已送出認證。
